...
export default function ParallaxPage() {
	return (
		<section className="bg-blue-900 h-dvh overflow-y-auto overflow-x-hidden perspective-[5px]">
	...
	return (
		<>
			<article className="relative flex justify-center items-center h-full -z-1 transform-3d">
				<div className="absolute h-screen w-screen translate-z-[-5px] scale-200">
...
const ContentSection2 = ({ src }: { src: string }) => {
	return (
		<>
			<article className="relative left-80 flex justify-center items-center h-full -z-1 transform-3d">
				<div className="absolute h-[400px] w-[300px] left-0 top-[100dvh] mx-auto translate-z-[-5px] scale-250">
					<Image src={src} className="object-cover" fill alt="Hero" />
				</div>
				<h2 className="text-black text-6xl font-bold tracking-widest absolute bottom-40 left-0 translate-z-[-4px] scale-150 px-12 py-6 bg-slate-100">
					Scroll Down Section
				</h2>
			</article>
			<article className=" text-black flex flex-col items-center gap-12 min-h-dvh w-[500px] translate-x-[50dvw]">
				<div className="p-10 bg-slate-100/95">
					<h3 className="text-3xl font-bold tracking-widest">Parallax Efect</h3>
					<p className="w-full text-center">
						Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid
						incidunt ab suscipit, neque ad vel tenetur, quaerat corrupti
						...
						exercitationem architecto nihil obcaecati ducimus, repudiandae
						eligendi peraesentium unde tempora. Lorem ipsum dolor sit amedt
						consectetur adipisicing elit. Aliquid incidunt ab suscipit, neque ad
						vel tenetur, quaerat corrupti mollitia iure a ipsam. Nihil, ad, odio
						ipsum quis cum neque pariatur quibusdam dolore qui molestiae ea
						ullam libero sequi! Atque eius exercitationem architecto nihil
						obcaecati ducimus, repudiandae eligendi praesentium unde tempora.
					</p>
				</div>
